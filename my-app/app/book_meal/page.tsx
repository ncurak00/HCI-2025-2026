...
export default function Page() {
  ...
  // On first load (or when URL changes), read ?category=... and apply filter + scroll
  useEffect(() => {
  ...
  function updateCategory(cat: Category) {
    ...
    // Smooth scroll to menu list (feels nice after tapping chips on mobile)
    setTimeout(() => {
      menuRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
    }, 50);
  }
  ...
  return (
    <main className="w-full bg-white text-gray-900">
      <div className="mx-auto w-full max-w-6xl px-4 py-10">
        ...
        <section
          ref={menuRef}
          className="grid gap-6 scroll-mt-24 sm:grid-cols-2 lg:grid-cols-3"
        >
